...
func Registry(config Config) map[string]func() checkruntime.Check {
	return map[string]func() checkruntime.Check{
		...
		"PendingRenovateGitLabMRs": func() checkruntime.Check { return checks.NewPendingRenovateGitLabMRs(config.PAT, config.Client) },
		"ProperDockerfile":        func() checkruntime.Check { return checks.NewProperDockerfile() },
		"ServiceMaturity":          func() checkruntime.Check { return checks.NewServiceMaturity() },
	}
}
