...
public class WithGitRepoWithoutFile : TestWithNeighboringDirectoryFixture
{
    [Test]
    public async Task DeterministicallyRendersServiceInfo()
    {
        ...
        var git = Process.Start(new ProcessStartInfo
            {
                FileName = "git",
                Arguments = $"clone -b nofile-azure https://github.com/ViMaSter/service-scorecard-generator-test-fixture.git {actualOutputPath}",
